...
PrometheusJudge = PrometheusEval(model=model, absolute_grade_template=ABSOLUTE_PROMPT)
...
if __name__ == "__main__":
    ...
    feedback, score = PrometheusJudge.single_absolute_grade(
